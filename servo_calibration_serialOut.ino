/* Callibration code for a number of servos
this code is modified largely from the Instructible
Servo Feedback Hack by Instructible User Rachel Instructs
http://www.instructables.com/id/Servo-Feedback-Hack-free/step8/Auto-Range-Setting/
The code has been cleaned up and made more efficient in places, but is largely the same
*/
